...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let citiesArray: [City] = self.persistentContainer.viewContext.allItems(City.self)
        self.mainScreenViewModel = MainScreenViewModel(weatherManager: weatherManager, cities: citiesArray)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "weather_mvvm_example")
